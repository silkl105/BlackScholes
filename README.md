...
<table>
  <tr>
    ...
    <td>A fully interactive <strong>Streamlit</strong> web application is included. Try the app live on Streamlit Cloud: https://application-blackscholes.streamlit.app</td>
  </tr>
</table>
