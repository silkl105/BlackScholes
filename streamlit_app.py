...
def main() -> None:
    ...
    with tab3:
        ...
        if not cached_maturities or not cached_yields:
            ...
            st.markdown(f"Please find the US Treasury Yield curve from 1m to 30y below, with yields in continuous terms, as of {formatted_date}. Select the `Use US Yield Curve` button on the sidebar to use it for risk-free rate calculations.")
            ...
            **Technical Construction:**  
            ...
            4. Use cubic interpolation to get a smooth curve from 1 month to 30 years.
